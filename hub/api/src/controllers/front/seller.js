  ...
  try {
    ...
    if (!newUser) {
      await sendMail(userMail,
        'Convite Hub!',
        `Você acaba de receber um convite de ${user.name} para fazer acessar o Digirow Hub, para completar o cadastro acesse o link: https://app.diegovieira.com.br/register/${encode(userMail)}`,
        config,
      )
    }
