...
import { GuideSlider } from 'digi-components';
import { toggleAction, openAction, playTransitionAction } from 'digi-redux/actions/uiActions';
import { logout } from 'digi-redux/actions/authActions';
import dummy from 'digi-api/dummy/dummyContents';
...
function Dashboard(props) {
  ...
  const tooggleSavedDrawerStatus = (drawerStatus) => {
    ...
    >
      ...
      { /* Left Sidebar Layout */
        layout === 'sidebar' && (
          <LeftSidebarLayout
            history={history}
            toggleDrawer={tooggleSavedDrawerStatus}
