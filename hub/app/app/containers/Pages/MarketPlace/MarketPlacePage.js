...
function MarketPlacePage(props) {
  ...
  const submit = () => {
    window.location.href = `https://auth.mercadolivre.com.br/authorization?response_type=code&client_id=3622855487528749&redirect_uri=https://app.{url}.com.br/marketplace`;
  }
