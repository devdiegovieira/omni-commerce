 ...
 */
 ...
 module.exports = options => ({
   ...
   resolve: {
     ...
     alias: {
       'digi-components': path.resolve(__dirname, '../../app/components/'),
       'digi-containers': path.resolve(__dirname, '../../app/containers/'),
       'digi-styles': path.resolve(__dirname, '../../app/styles/components/'),
       'digi-api': path.resolve(__dirname, '../../app/api/'),
       'digi-images': path.resolve(__dirname, '../../public/images/'),
       'digi-vendor': path.resolve(__dirname, '../../node_modules/'),
       'digi-redux': path.resolve(__dirname, '../../app/redux'),
     }
   },
